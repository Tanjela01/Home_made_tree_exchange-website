...
-- Database: `home_made_tree_exchange`
...
INSERT INTO `blogdata` (`blogId`, `blogUser`, `blogTitle`, `blogContent`, `likes`) VALUES
...
(19, 'Mast yarr', 'ThePhenom', 'profile0.png');
...
(3, 'K', 'ThePhenom', 'ti', 'cd', 'tanjela@gmail.com', '8600611198', 'abcde', 0, 0, 'png', 0);
...
CREATE TABLE `fproduct` (
  ...
  `pimage` varchar(255) NOT NULL DEFAULT 'tomato'.jpg',
  `picStatus` int(10) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(3, 27, 'Mango', 'Fruit', '<p>Mango </p>\r\n', 500, 'Mango3.jpg', 1),
(3, 28, 'Ladyfingertree', 'Vegetable', '<p>Its veggie</p>\r\n', 1000, 'Ladyfinger3.jpg', 1);
