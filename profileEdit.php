            ...
            <div class="inner">
                ...
                <form method="post" action="Profile/updateProfile.php">
                    <div class="row uniform">
                        ...
                        <div class="3u 12u$(small)">
                            <input type="checkbox" id="btech" name="edu" value="B.TECH">
                            <label for="btech">B.TECH</label>
                        </div>
                         <div class="3u 12u$(small)">
                            <input type="checkbox" id="mtech" name="edu" value="M.TECH">
                        ...
                        <div class="2u 12u$(small)">
                            <input type="checkbox" id="1" name="year" value="1" checked>
