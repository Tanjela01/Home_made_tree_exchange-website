	...
	<div class="container">
		...
		<div class="row 200%">
			...
			<section class="4u 12u$(small)">
				...
				<p>home made tree exchange-Blog</p>
			</section>
			<section class="4u$ 12u$(small)">
...
<footer class="footer-distributed" style="background-color:black" id="aboutUs">
	...
	<div class="footer-left">
		<h3 style="font-family: 'Times New Roman', cursive;">home made tree exchange  &copy; </h3>
		<!--	<div class="logo">
	...
	<div class="footer-center">
		<div>
			...
			<p style="font-size:20px">home made tree exchange<span>  </span></p>
		</div>
		<div>
		...
		<div>
			...
			<p style="font-size:20px"><a href="mailto:home made tree exchange@gmail.com" style="color:white">demo@demo.com</a></p>
		</div>
	</div>

	<div class="footer-right">
		<p class="footer-company-about" style="color:white">
			<span style="font-size:20px"><b>home made tree exchange</b></span>
			home made tree exchange is e-commerce trading platform for grains & grocerries...
		</p>
